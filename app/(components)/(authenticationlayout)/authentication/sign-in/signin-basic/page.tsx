            ...
            <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-6 sm:col-span-8 col-span-12">
                <div className="my-[2.5rem] flex justify-center">
                    <Link href="/dashboards/analytics/">
                        <img src="../../../assets/images/icons/logo.png" alt="logo" className="desktop-logo"/>
                        <img src="../../../assets/images/icons/logo.png" alt="logo" className="desktop-dark"/>
                    </Link>
                </div>
                <div className="box">
                    <div className="box-body !p-[3rem]">
                        ...
                        <div className="grid grid-cols-12 gap-y-4">
                            ...
                            {/* <div className="xl:col-span-12 col-span-12 grid mt-2">
                                <Link href="/dashboards/analytics/" className="ti-btn ti-btn-primary !bg-primary !text-white !font-medium">Sign In</Link>
                            </div> */}
                        </div>
